...
各カテゴリー（${categoriesText}）からバランスよくスポットを選び、search_nearby_placesツールで検索してください。各カテゴリーから少なくとも1スポットを含めるようにしてください。予算${budget.toLocaleString()}円・${durationHours}時間以内のプランを純粋なJSON形式のみで返答してください。`;
}
