...
{ "title": "プランタイトル", "selectedAliases": ["R2", "C1", "M1"] }

titleはプランの魅力を伝える日本語の短いタイトル（例: 「渋谷グルメ夜散策」「新宿文化探訪」）`;
...
## 指示
時間帯・天気・カテゴリバランスを考慮して2〜4件選び、自然な訪問順序に並べてタイトルをつけてください。
出力はJSON: { "title": "...", "selectedAliases": ["X1", "Y2", "Z3"] }`;
}
